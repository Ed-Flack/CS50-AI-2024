...
![Corpus of web pages](https://github.com/user-attachments/assets/3704462e-13aa-4a33-bacc-789e250b9083)
...
![Disconnected corpus of web pages](https://github.com/user-attachments/assets/6d5b44b2-28e9-46db-82d0-d3cdf964a643)
...
![PageRank formula](https://github.com/user-attachments/assets/8a0bdfa8-67d9-4814-a0e4-fc0038398df0)
...
Many students have had issues with the autograders on this assignment because of how their dictionaries are constructed (that is to say, _improperly_). It is imperative that you read this specification carefully and implement its requirements **exactly**.
...
Remember that **you may not import any modules** (other than those in the Python standard library) **other than those explicitly authorized herein**. There are certainly tools out there that trivialize some of these projects, but that’s not the goal here; you’re learning things at a lower level. If we don’t say here that you can use them, you can’t use them.
